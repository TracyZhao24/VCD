...
file4 = 'coco_pope_random_answers_with_colorjitter_seed55.jsonl'
file5 = 'coco_pope_random_answers_with_segment_cd_seed55.jsonl'
output_file = 'coco_ensemble5.json'
